...
// '-----------------------------------------------------------------------------------------------------------------------------------------------------------------'
// 28/08/24 Created skill.js endpoint to allow for skills to be created
    ...
    if (url === '/skill' && method === 'GET') {
        ...
        req.on('end', async () => {
            try {
                ...
                // skillID created by adding 1 to the existing highest skillID to stop duplicates from occuring.
